## Script to create a series of line plots of Global Active Power, Energy Sub-metering, Voltage,
## and Global Reactive Power over time in a 2x2 display for the dates 2/1/07 and 2/2/07 from
...
par(mfcol=c(2, 2))  ## set mfcol to 2x2 display of plots

## plot the following as a series of line plots in a 2x2 display:
##  - Global_active_power versus Time
##  - Sub_metering_1, Sub_metering_2, and Sub_metering_3 versus Time
##  - Voltage versus Time
...
par(mfcol=c(1, 1))  ## reset mfcol parameter
